...
var stringUtilTest = {
    tests: [
        ...
        },
        {
            ...
            execute: function () {
                stringUtil.setString("Hello world");
                var str = stringUtil.readUntil(function (c) { return c == " "; });
        ...
        },
        {
            ...
            execute: function () {
                stringUtil.setString("Hello world");
                stringUtil.position = 5;
                var pos = stringUtil.searchLeft(function (c) { return c == 'H'; });
                assertEqual(0, pos);
                assertEqual(5, stringUtil.position);
                pos = stringUtil.searchLeft(function (c) { return c == 'x'; });
                assertEqual(-1, pos);
                assertEqual(5, stringUtil.position);
            }
        },
        {
            ...
            execute: function () {
                stringUtil.setString("Hello world");
                stringUtil.position = 5;
                var pos = stringUtil.searchRight(function (c) { return c == 'd'; });
                assertEqual(10, pos);
                assertEqual(5, stringUtil.position);
                pos = stringUtil.searchRight(function (c) { return c == 'x'; });
                assertEqual(-1, pos);
                assertEqual(5, stringUtil.position);
            }
        },
